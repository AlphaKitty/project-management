...
import com.projectmanagement.exception.BusinessException;
...
public class AuthController {
     ...
     */
    @PostMapping("/login")
    @OperationLog(type = OperationType.LOGIN, module = BusinessModule.AUTH, description = "用户登录", recordParams = false)
     ...
     */
    @PostMapping("/logout")
    @OperationLog(type = OperationType.LOGOUT, module = BusinessModule.AUTH, description = "用户登出")
